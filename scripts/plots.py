...
class GeneratePlots():
    ...
    def __init__(self, config_path: str = "./config.yml") -> None:
        ...
        self.logger.info("The type of the column 'Date' was changed to datetime type.")

    def plot_graph1_preprocessing(self) -> None:
        # Getting the data to BRL Exchange rate for president
        ...
        self.logger.info("The rolling mean was applied to BOLSONARO dataframe.")
